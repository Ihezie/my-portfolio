...
const Footer = () => {
  ...
  return (
    <footer className="py-6 border-off-white border-t-2 gap-3 nav-footer-px font-semibold text-center flex flex-col-reverse justify-between items-center sm:flex-row">
